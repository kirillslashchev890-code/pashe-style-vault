      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${tab === "orders" ? "bg-primary text-primary-foreground" : "bg-card border border-border hover:bg-secondary"}`}
          >
            <Package size={18} /> Заказы
          </button>
          <button
            onClick={() => setTab("users")}
            className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${tab === "users" ? "bg-primary text-primary-foreground" : "bg-card border border-border hover:bg-secondary"}`}
          >
