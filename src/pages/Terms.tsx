  ...
  <Layout>
    <div className="container mx-auto px-4 py-12 md:py-16 max-w-3xl">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-muted-foreground mb-12">Пользуясь сайтом ЮВЕНТУС, вы соглашаетесь с настоящими условиями.</p>

        <Section title="1. Предмет соглашения">
          <p>Настоящие условия регулируют отношения между ЮВЕНТУС и пользователями сайта при заказе товаров.</p>
        </Section>
        ...
        <Section title="6. Интеллектуальная собственность">
          <p>Все материалы сайта (тексты, фото, логотипы) принадлежат ЮВЕНТУС. Копирование без согласия запрещено.</p>
        </Section>
        <Section title="7. Ограничение ответственности">
          <p>ЮВЕНТУС не несёт ответственности за временные сбои в работе сайта и действия третьих лиц (банк, курьер).</p>
        </Section>
