...
export const products: Product[] = [
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Premium Line", "Urban Style"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Premium Line", "Classic Edition"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Classic Edition", "Premium Line"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Urban Style", "Classic Edition"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Urban Style", "Premium Line"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Sport Collection", "Urban Style"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Sport Collection", "Classic Edition"][i % 3],
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    ...
    return {
      ...
      brand: ["ЮВЕНТУС Original", "Urban Style", "Sport Collection"][i % 3],
