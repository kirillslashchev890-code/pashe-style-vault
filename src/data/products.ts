...
export const products: Product[] = [
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Турция",
    images: [
      `https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Италия",
    images: [
      `https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1544923246-77307dd628b1?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Португалия",
    images: [
      `https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
      { name: "S", available: true },
      { name: "M", available: true },
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Турция",
    images: [
      `https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Турция",
    images: [
      `https://images.unsplash.com/photo-1542272604-787c3835535d?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Турция",
    images: [
      `https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1517438476312-10d79c077509?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
      { name: "S", available: true },
      { name: "M", available: true },
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Португалия",
    images: [
      `https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1578768079052-aa76e52ff62e?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
      { name: "S", available: i % 3 !== 0 },
      { name: "M", available: true },
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Турция",
    images: [
      `https://images.unsplash.com/photo-1625910513413-5fc41ef81b18?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
      { name: "S", available: true },
      { name: "M", available: true },
    ...
    colors: ["Белый", "Тёмно-синий", "Бордовый"],
    isNew: i < 3,
    isSale: i % 4 === 0,
  })),
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Италия",
    images: [
      `https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
    ...
    colors: ["Чёрный", "Белый", "Коричневый"],
    isNew: i < 4,
    isSale: i % 3 === 0,
  })),
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Италия",
    images: [
      `https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1594223274512-ad4803739b7c?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
      { name: "ONE SIZE", available: true },
    ],
    colors: ["Чёрный", "Коричневый", "Тёмно-синий"],
    isNew: i < 5,
    isSale: i % 4 === 0,
  })),
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Турция",
    images: [
      `https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1521369909029-2afed882baee?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
  ...
  ...Array.from({ length: 20 }, (_, i) => ({
    ...
    country: "Италия",
    images: [
      `https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&h=1000&fit=crop&q=${80 + i}`,
      `https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=1000&fit=crop&q=${80 + i}`,
    ],
    sizes: [
